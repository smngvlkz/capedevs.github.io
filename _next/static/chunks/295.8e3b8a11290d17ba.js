            ...
            for (
              ...
              (e = (function () {
                var e = h(),
                  n = y(i);
                if (n) {
                  if ((v(), !y(l))) return g("property missing ':'");
                  var r = y(o),
                    u = e({
                      type: "declaration",
    ...
    3295: function (e, t, n) {
            ...
            : "mdxJsxFlowElement" === t.type || "mdxJsxTextElement" === t.type
              ? (function (e, t, n) {
                  ...
                  "svg" === t.name &&
                    ...
                    ((i = j), (e.schema = i)),
                    e.ancestors.push(t);
                  let o = null === t.name ? e.Fragment : ep(e, t.name, !0),
                    a = (function (e, t) {
                      let n = {};
              ...
              : "mdxjsEsm" === t.type
                ...
                : "root" === t.type
                  ? (function (e, t, n) {
                      let r = {};
                      return ec(r, ef(e, t)), e.create(t, e.Fragment, r, n);
                    })(e, t, n)
                  : "text" === t.type
                    ? t.value
                    : void 0;
          ...
          tokenize: function (e) {
            ...
            function u(e) {
              if ((o++, i.containerState._closeFlow)) {
                ...
                return (
                  (0, ev.d)(i.events, l + 1, 0, i.events.slice(r)),
                  (i.events.length = a),
                  s(e)
                );
              }
      ...
      let eO = {
        ...
        eA = {
          tokenize: function (e, t, n) {
            ...
            function i(i) {
              if (null === i || (0, eE.Ch)(i)) return n(i);
            ...
            let t = this,
              n = e.attempt(
                ...
                e.attempt(
                  ...
                  (0, eC.f)(
                    e,
                    e.attempt(this.parser.constructs.flow, r, e.attempt(eO, r)),
                    "linePrefix",
                  ),
                ),
              );
      ...
      function eY(e, t, n, r, i, l) {
        ...
        function c(t) {
          return null === t ||
            ...
            : (e.consume(t), o || (o = !(0, eE.xz)(t)), 92 === t ? f : c);
        }
        function f(t) {
      ...
      let eX = {
          tokenize: function (e, t, n) {
            ...
            function l(e) {
              return null === e || (0, eE.Ch)(e) ? t(e) : n(e);
            }
          },
          partial: !0,
        },
        eJ = {
          ...
          tokenize: function (e, t, n) {
            ...
            return function (t) {
              return (
                e.enter("codeIndented"), (0, eC.f)(e, i, "linePrefix", 5)(t)
              );
            };
            function i(t) {
              let i = r.events[r.events.length - 1];
      ...
      let e7 = {
        ...
        tt = {
          ...
          tokenize: function (e, t, n) {
              ...
              return r
                ? r._inactive
                  ...
                  : ((i = l.parser.defined.includes(
                      (0, eQ.d)(
                        l.sliceSerialize({ start: r.end, end: l.now() }),
                      ),
                    )),
                    e.enter("labelEnd"),
                    e.enter("labelMarker"),
            ...
            function a(t) {
              return 40 === t
                ? e.attempt(tn, s, i ? s : c)(t)
                : 91 === t
                  ? e.attempt(tr, s, i ? u : c)(t)
                  : i
                    ? s(t)
                    : c(t);
            }
            function u(t) {
              return e.attempt(ti, s, c)(t);
            }
            function s(e) {
              return t(e);
            }
              ...
              for (n = c; n--; )
                if (
                  ...
                  tu(f, -a),
                    ...
                    (e[c][1].start = Object.assign({}, o.end)),
                    (u = []),
            ...
            tokenize: function (e, t, n) {
              ...
              function s(o) {
                return 33 === o
                  ...
                  : 47 === o
                    ? (e.consume(o), (i = !0), h)
                    : 63 === o
                      ? (e.consume(o), (r = 3), u.interrupt ? t : L)
                      : (0, eE.jv)(o)
              ...
              function d(o) {
                if (null === o || 47 === o || 62 === o || (0, eE.z3)(o)) {
                  let a = 47 === o,
                    s = l.toLowerCase();
                  return !a && !i && e1.includes(s)
                    ? ((r = 1), u.interrupt ? t(o) : C(o))
                    : e0.includes(l.toLowerCase())
                      ? ((r = 6), a)
                        ? (e.consume(o), m)
                        : u.interrupt
                          ? t(o)
                      ...
                      : ((r = 7),
                        u.interrupt && !u.parser.lazy[u.now().line]
                          ...
                          : i
                            ? (function t(n) {
                                return (0, eE.xz)(n) ? (e.consume(n), t) : S(n);
                              })(o)
                            : g(o));
                }
              ...
              let t = {
                ...
                exit: {
                  ...
                  characterReference: function (e) {
                    this.stack.pop().position.end = tC(e.end);
                  },
                  ...
                  lineEnding: function (e) {
                    ...
                    if (this.data.atHardBreak) {
                      (n.children[n.children.length - 1].position.end = tC(
                        e.end,
                      )),
              ...
              (function (e) {
                ...
                (function (e) {
                  let t = {
                    defined: [],
                    lazy: {},
                    constructs: (0, ew.W)([i, ...((e || {}).extensions || [])]),
                    content: n(eI),
                    document: n(eT),
                    flow: n(eL),
                    string: n(eM),
                    ...
                    function (e, t, n) {
                      ...
                      for (
                        e =
                          ...
                          l = 0,
                          u = "",
                          s && (65279 === e.charCodeAt(0) && l++, (s = void 0));
                        l < e.length;
            ...
            l = (r) => {
              ...
              switch (o) {
                ...
                case 6: {
                  let t = [],
                    n = i([o, t], r);
                  for (let n of r) (e || !tD(tL(n))) && t.push(l(n));
                  return n;
                }
              }
              let { message: u } = r;
            ...
            let n = t || tW,
              ...
              l = {
                ...
                one: function (e, t) {
                  let n = e.type,
                    r = l.handlers[n];
                  if (tY.call(l.handlers, n) && r) return r(l, e, t);
                  if (
      ...
      class t9 {
        constructor(e) {
          ...
          for (n in t) t6.includes(n) || (this[n] = t[n]);
        }
        get basename() {
      ...
      function t7(e, t) {
        if (e && e.includes(t4.sep))
          throw Error(
            "`" + t + "` cannot be a path: did not expect `" + t4.sep + "`",
          );
      }
      function t8(e, t) {
      ...
      class nr extends nt {
        ...
        data(e, t) {
          return "string" == typeof e
            ? 2 == arguments.length
              ? (na("data", this.frozen), (this.namespace[e] = t), this)
              : (nn.call(this.namespace, e) && this.namespace[e]) || void 0
            : e
              ? (na("data", this.frozen), (this.namespace = e), this)
              : this.namespace;
        }
        freeze() {
        ...
        process(e, t) {
          ...
          return (
            this.freeze(),
            nl("process", this.parser || this.Parser),
        ...
        runSync(e, t) {
          ...
          return (
            ...
            ns("runSync", "run", r),
            (0, l.ok)(n, "we either bailed on an error or have a tree"),
            n
          );
        }
        stringify(e, t) {
      ...
      function nm(e) {
        let t = e.allowedElements,
          ...
          u = e.rehypePlugins || nf,
          s = e.remarkPlugins || nf,
          c = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...np } : np,
          f = e.skipHtml,
          p = e.unwrapDisallowed,
          h = e.urlTransform || ng,
          d = ni().use(tI).use(s).use(tG, c).use(u),
          m = new t9();
        ...
        return (
          ...
          (0, tH.Vn)(y, function (e, r, i) {
            ...
            if ("element" === e.type) {
              let l = t ? !t.includes(e.tagName) : !!a && a.includes(e.tagName);
              if (
                (!l && n && "number" == typeof r && (l = !n(e, r, i)),
                l && i && "number" == typeof r)
              )
                return (
                  p && e.children
          ...
          (function (e, t) {
            ...
            if (t.development) {
              ...
              (n = t.jsxDEV),
                (l = function (e, t, r, i) {
                  let l = Array.isArray(r.children),
                    a = K(e);
                  return n(
                    t,
                    r,
