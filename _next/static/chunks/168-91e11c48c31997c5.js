    ...
    7168: function (t, e, n) {
      ...
      function w(t, e) {
        ...
        let s =
          ...
          f = m.getDay();
        return (
          m.setDate(m.getDate() - ((f < s ? 7 : 0) + f - s)),
          m.setHours(0, 0, 0, 0),
          m
        );
      }
      ...
      let M = {
        ...
        x = {
                  ...
                  (+w(n, e) -
                    +(function (t, e) {
                      ...
                      let s =
                        ...
                        m = g(t, 0);
                      return (
                        m.setFullYear(h, 0, s), m.setHours(0, 0, 0, 0), w(m, e)
                      );
                    })(n, e)) /
                    6048e5,
                ) + 1
                  ...
                  (+v(e) -
                    +(function (t) {
                      let e = b(t),
                        n = g(t, 0);
                      return (
                        n.setFullYear(e, 0, 4), n.setHours(0, 0, 0, 0), v(n)
                      );
                    })(e)) /
                    6048e5,
                ) + 1
          ...
          t: function (t, e, n) {
            return p(Math.trunc(t.getTime() / 1e3), e.length);
          },
          T: function (t, e, n) {
            return p(t.getTime(), e.length);
          },
        };
      function P(t) {
        let e =
      ...
      function W(t) {
        let e =
          ...
          n = Math.abs(t);
        return (
          (t > 0 ? "-" : "+") + p(Math.trunc(n / 60), 2) + e + p(n % 60, 2)
        );
      }
      let D = (t, e) => {
          switch (t) {
            ...
            null !==
              (P =
                null !==
                  ...
                  ? k
                  : null === (m = c.locale) || void 0 === m
                    ? void 0
                    : null === (d = m.options) || void 0 === d
                      ? void 0
                      : d.weekStartsOn) && void 0 !== P
              ? P
              : 0,
          T = h(t);
        if (
